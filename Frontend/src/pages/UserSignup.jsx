  ...
  return (
    <div>
      <div className='p-7 h-screen flex flex-col justify-between'>
        <div>
          <form onSubmit={(e) => submitHandler(e)}>
            ...
            <div className='flex gap-4 mb-6'>
              <input
              required
              className='bg-gray-200  w-1/2 rounded py-2 px-4  border text-base placeholder:text-sm'
              type="Text"
            ...
            <input
              required
              className='bg-gray-200 mb-6 rounded py-2 px-4  w-full border text-base placeholder:text-sm'
              type="email"
        ...
        <div>
          <NavLink to='/captain-login' className='bg-yellow-400 border-yellow-400 flex items-center justify-center mb-6 px-3 py-3 w-full font-semibold text-white rounded'>Sign in as Captain</NavLink>
        </div>
      </div>
    </div>
  )
